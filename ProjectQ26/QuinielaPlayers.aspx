<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="QuinielaPlayers.aspx.cs" Inherits="ProjectQ26.QuinielaPlayers" %>
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <asp:UpdatePanel ID="UpdatePanelModalApuestas" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="gridQuinielaModalApuestas" OnRowDataBound="gridQuinielaModalApuestas_RowDataBound" runat="server" CssClass="TableNewModal100" AutoGenerateColumns="false"
